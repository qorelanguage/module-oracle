        ...
        switch (col->ocode)
        {
            ...
            case SQLT_NUM:
                if (col->scale == -127 && col->prec > 0)
                    ...
                    // int
                    rv->setKeyValue(cname, new QoreBigIntNode(OCI_ObjectGetBigInt2(&conn->ocilib, obj, cname)), xsink);
                break;
        ...
        switch (col->ocode)
        {
            ...
            case SQLT_NUM:
                if (col->scale == -127 && col->prec > 0)
                    ...
                    // int
                    rv->set_entry(rv->size(), new QoreBigIntNode(OCI_ElemGetBigInt2(&conn->ocilib, e)), xsink);
                break;
