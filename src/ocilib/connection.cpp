...
boolean OCI_API OCI_SetDefaultFormatNumeric(OCI_Library *pOCILib, OCI_Connection *con, const mtext *format)
{
    boolean res = TRUE;
    ...
    con->fmt_num = mtsdup(pOCILib, format ? format : OCI_STRING_FORMAT_NUM);
...
const mtext * OCI_API OCI_GetDefaultFormatNumeric(OCI_Library *pOCILib, OCI_Connection *con)
{
    ...
    if (con->fmt_num == NULL)
       OCI_SetDefaultFormatNumeric(pOCILib, con, NULL);
