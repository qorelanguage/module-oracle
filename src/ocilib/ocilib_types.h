...
OCI_EXPORT void OCI_ExceptionNotInitialized2(OCI_Library *pOCILib, ExceptionSink* xsink = 0);
...
OCI_EXPORT void OCI_ExceptionNullPointer2(OCI_Library *pOCILib, int type, ExceptionSink* xsink = 0);
